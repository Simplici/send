...
sendYourFilesLink = Isprobajte Panda Send
...
notSupportedOutdatedDetail = Nažalost, ovo izdanje Firefoxa ne podržava web tehnologiju koja omogućava Panda Send. Morat ćete ažurirati vaš preglednik.
...
javascriptRequired = Za Panda Send je potreban JavaScript
whyJavascript = Zašto je za Panda Send potreban JavaScript?
