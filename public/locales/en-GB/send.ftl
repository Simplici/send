...
# Panda Send is a brand name and should not be localized.
downloadMessage = Your friend is sending you a file with Panda Send, a service that allows you to share files with a safe, private, and encrypted link that automatically expires to ensure your stuff does not remain online forever.
...
# Panda Send is a brand name and should not be localized.
sendYourFilesLink = Try Panda Send
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Unfortunately this browser does not support the web technology that powers Panda Send. You’ll need to try another browser. We recommend Firefox!
notSupportedLink = Why is my browser not supported?
notSupportedOutdatedDetail = Unfortunately this version of Firefox does not support the web technology that powers Panda Send. You’ll need to update your browser.
...
legalNoticeTestPilot = Panda Send is currently a Test Pilot experiment, and subject to the Test Pilot <a>Terms of Service</a> and <a>Privacy Notice</a>. You can learn more about this experiment and its data collection <a>here</a>.
legalNoticeMozilla = Use of the Panda Send web site is also subject to Mozilla’s <a>Websites Privacy Notice</a> and <a>Websites Terms of Use</a>.
...
javascriptRequired = Panda Send requires JavaScript
whyJavascript = Why does Panda Send require JavaScript?
