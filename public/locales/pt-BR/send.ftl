...
sendYourFilesLink = Experimente o Panda Send
...
notSupportedOutdatedDetail = Infelizmente essa versão do Firefox não suporta a tecnologia web que faz o Panda Send funcionar. Você precisa atualizar o seu navegador.
...
whyJavascript = Por que o Panda Send precisa do JavaScript?
