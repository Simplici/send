...
notSupportedOutdatedDetail = Dessverre støttar ikkje denne versjonen av Firefox nett-teknologien som driv Panda Send. Du må å oppdatere nettlesaren din.
...
javascriptRequired = Panda Send krev JavaScript.
whyJavascript = Kvifor krev Panda Send JavaScript?
