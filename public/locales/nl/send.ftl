...
sendYourFilesLink = Panda Send proberen
...
notSupportedOutdatedDetail = Helaas ondersteunt deze versie van Firefox de webtechnologie die Panda Send gebruikt niet. U dient uw browser bij te werken.
...
javascriptRequired = Panda Send vereist JavaScript
whyJavascript = Waarom vereist Panda Send JavaScript?
