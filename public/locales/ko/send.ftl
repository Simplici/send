...
sendYourFilesLink = Panda Send 써보기
...
notSupportedOutdatedDetail = 안타깝게도 현재 브라우저 버전에서는 Panda Send에 사용되는 웹 기술을 지원하지 않습니다. 브라우저 업데이트가 필요합니다.
...
javascriptRequired = Panda Send는 자바스크립트를 필요로 합니다
whyJavascript = 왜 Panda Send에 자바스크립트가 필요하죠?
