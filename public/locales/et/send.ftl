...
uploadPageExplainer = Panda Send võimaldab saata faile üle ohutu, privaatse ja krüpteeritud kanali. Failid kustutatakse automaatselt, et need ei jääks internetti igaveseks.
...
# Panda Send is a brand name and should not be localized.
downloadMessage = Sulle on saadetud fail Panda Sendiga - teenusega, mis lubab faile ohutult, privaatselt ja krüpteeritult jagada. Failid kustutatakse automaatselt, et need ei jääks internetti igaveseks.
...
# Panda Send is a brand name and should not be localized.
sendYourFilesLink = Proovi Panda Sendi
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Kahjuks ei toeta see brauser veebitehnoloogiaid, mis teevad Panda Sendi toimimise võimalikuks. Sa pead proovima teise brauseriga. Me soovitame Firefoxi!
notSupportedLink = Miks mu brauser toetatud pole?
notSupportedOutdatedDetail = Kahjuks ei toeta see Firefoxi versioon veebitehnoloogiaid, mis teevad Panda Sendi toimimise võimalikuks. Sa pead oma brauserit uuendama.
...
legalNoticeTestPilot = Panda Send on praegu Test Piloti eksperiment ja sellele rakenduvad Test Piloti <a>teenusetingimused</a> ning <a>privaatsusreeglid</a>. Rohkem teavet selle eksperimendi ja kogutavate andmete kohta leiab <a>siit</a>.
legalNoticeMozilla = Panda Sendi veebilehe kasutamisele rakenduvad ka Mozilla <a>veebilehtede privaatsusreeglid</a> ja <a>veebilehtede teenusetingimused</a>.
...
javascriptRequired = Panda Send'i kasutamiseks tuleb JavaScript lubada
whyJavascript = Miks Panda Send JavaScripti vajab?
