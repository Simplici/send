...
sendYourFilesLink = Probá Panda Send
...
notSupportedOutdatedDetail = Desafortunadamente esta versión de Firefox no soporta la tecnología web que necesita Panda Send. Necesitás actualizar el navegador.
...
javascriptRequired = Panda Send requiere JavaScript
whyJavascript = ¿Por qué Panda Send requiere Java Script?
