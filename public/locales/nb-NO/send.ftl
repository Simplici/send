...
sendYourFilesLink = Prøv Panda Send
...
notSupportedOutdatedDetail = Dessverre støtter ikke denne versjonen av Firefox netteknologien som driver Panda Send. Du trenger å oppdatere nettleseren din.
...
javascriptRequired = Panda Send krever JavaScript.
whyJavascript = Hvorfor krever Panda Send JavaScript?
