...
sendYourFilesLink = Încearcă Panda Send
...
notSupportedOutdatedDetail = Din păcate, această versiune de Firefox nu suportă tehnologiile web din spatele Panda Send. Va trebui să actualizezi browserul.
...
javascriptRequired = Panda Send necesită JavaScript
whyJavascript = De ce Panda Send necesită JavaScript?
