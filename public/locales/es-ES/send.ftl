...
sendYourFilesLink = Prueba Panda Send
...
notSupportedOutdatedDetail = Lamentablemente, esta versión de Firefox no admite la tecnología web que impulsa Panda Send. Tendrás que actualizar tu navegador.
...
whyJavascript = ¿Por qué Panda Send requiere JavaScript?
