...
# Panda Send is a brand name and should not be localized.
downloadMessage = Yoldaşınız Panda Send ilə sizə fayl göndərir, fayllarınızı təhlükəsiz, məxfi, şifrələnmiş və daima onlayn qalmaması üçün avtomatik silən fayl göndərmə xidməti.
...
# Panda Send is a brand name and should not be localized.
sendYourFilesLink = Panda Send Yoxla
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Heyf ki, bu səyyah Panda Send-ə güc verən web texnologiyalarını dəstəkləmir. Fərqli bir səyyah yoxlamalısınız. Biz Firefox məsləhət görürük!
notSupportedLink = Səyyahım niyə dəstəklənmir?
notSupportedOutdatedDetail = Heyf ki, Firefox səyyahının bu versiyası Panda Send-ə güc verən web texnologiyalarını dəstəkləmir. Səyyahınızı yeniləməlisiniz.
...
legalNoticeTestPilot = Panda Send Test Pilot eksperimentidir, Test Pilot <a>Xidmət Şərtləri</a> və <a>Məxfilik Bildirişi</a>-nə tabedir. Bu eksperiment və məlumat yığma haqqında <a>buradan</a> öyrənə bilərsiz.
legalNoticeMozilla = Panda Send saytının istifadəsi həmçinin Mozilla-nın <a>Saytlar üçün Məxfilik Bildirişi</a> və <a>Sayt İstifadə Şərtləri</a>-nə tabedir.
...
javascriptRequired = Panda Send üçün JavaScript lazımdır
whyJavascript = Panda Send niyə JavaScript tələb edir?
