...
sendYourFilesLink = Titojtob'ëx Panda Send
...
notSupportedOutdatedDetail = K'ayew ruma re ruwäch Firefox re' man nuköch' ta ri ajk'amaya'l na'ob'äl nrajo' ri Panda Send. Rajowaxik nak'ëx ri awokik'amaya'l.
...
javascriptRequired = K'atzinel JavaScript chi re ri Panda Send
whyJavascript = ¿Achike ruma toq ri Panda Send nrajo' JavaScript?
