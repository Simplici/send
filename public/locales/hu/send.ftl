...
sendYourFilesLink = Próbálja ki a Panda Sendet
...
notSupportedOutdatedDetail = Sajnos a Firefox ezen verziója nem támogatja a Panda Send alapját képező technológiát. Frissítenie kell a böngészőjét.
...
javascriptRequired = A Panda Sendhez JavaScript szükséges
whyJavascript = Miért van szükség JavaScriptre a Panda Sendhez?
