...
sendYourFilesLink = Prova Panda Send
...
notSupportedOutdatedDetail = Purtroppo questa versione di Firefox non supporta le tecnologie web alla base di Panda Send. È necessario aggiornare il browser.
...
javascriptRequired = Panda Send richiede JavaScript
whyJavascript = Perché Panda Send richiede JavaScript?
