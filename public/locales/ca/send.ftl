...
sendYourFilesLink = Proveu el Panda Send
...
notSupportedOutdatedDetail = Aquesta versió del Firefox no admet la tecnologia web amb què funciona el Panda Send. Haureu d'actualitzar el navegador.
...
javascriptRequired = El Panda Send necessita JavaScript
whyJavascript = Per què el Panda Send necessita JavaScript?
