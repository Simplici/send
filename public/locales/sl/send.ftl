...
sendYourFilesLink = Preskusite Panda Send
...
notSupportedOutdatedDetail = Ta brskalnik žal ne podpira tehnologije, na kateri temelji Panda Send. Svoj brskalnik boste morali posodobiti.
...
javascriptRequired = Panda Send zahteva JavaScript
whyJavascript = Zakaj Panda Send zahteva JavaScript?
