...
sendYourFilesLink = Coba Panda Send
...
notSupportedOutdatedDetail = Sayangnya Firefox versi ini tidak mendukung teknologi web yang menggerakkan Panda Send. Anda perlu memperbarui peramban Anda.
...
javascriptRequired = Panda Send membutuhkan JavaScript.
whyJavascript = Mengapa Panda Send membutuhkan JavaScript?
