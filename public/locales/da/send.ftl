...
notSupportedOutdatedDetail = Desværre understøtter denne version af Firefox ikke den webteknologi, som driver Panda Send. Du skal opdatere din browser.
...
javascriptRequired = Panda Send kræver JavaScript
whyJavascript = Hvorfor kræver Panda Send JavaScript?
