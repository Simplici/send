...
sendYourFilesLink = Panda Send を試す
...
notSupportedOutdatedDetail = 残念ながらお使いのバージョンの Firefox は Panda Send が活用しているウェブ技術に対応していません。ブラウザーを更新する必要があります。
...
javascriptRequired = Panda Send を使うには JavaScript が必要です
whyJavascript = Panda Send が JavaScript を必要とする理由
