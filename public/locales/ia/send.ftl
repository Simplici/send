...
sendYourFilesLink = Proba Panda Send
...
notSupportedOutdatedDetail = Infelicemente iste version de Firefox non supporta le nove technologias web que move Panda Send. Tu besonia de actualisar tu navigator.
...
javascriptRequired = Panda Send require JavaScript
whyJavascript = Proque Panda Send require JavaScript?
