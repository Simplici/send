...
sendYourFilesLink = Wypróbuj Panda Send
...
notSupportedOutdatedDetail = Ta wersja Firefoksa nie obsługuje technologii internetowej, która napędza Panda Send. Należy uaktualnić przeglądarkę.
...
javascriptRequired = Panda Send wymaga języka JavaScript
whyJavascript = Dlaczego Panda Send wymaga języka JavaScript?
