...
sendYourFilesLink = Essayer Panda Send
...
notSupportedOutdatedDetail = Malheureusement, cette version de Firefox ne prend pas en charge les technologies web utilisées par Panda Send. Vous devez mettre à jour votre navigateur.
...
javascriptRequired = Panda Send nécessite JavaScript
whyJavascript = Pourquoi Panda Send nécessite-t-il JavaScript ?
