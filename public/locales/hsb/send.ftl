...
sendYourFilesLink = Panda Send wupruwować
...
notSupportedOutdatedDetail = Bohužel tuta wersija Firefox webtechnologiju njepodpěruje, na kotrejž Panda Send bazuje. Dyrbiće swój wobhladowak aktualizować.
...
javascriptRequired = Panda Send JavaScript trjeba
whyJavascript = Čehodla Panda Send JavaScript trjeba?
