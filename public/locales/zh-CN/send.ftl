...
sendYourFilesLink = 试试 Panda Send
...
notSupportedOutdatedDetail = 很可惜，此版本的 Firefox 不支持 Panda Send 所使用的 Web 技术。您需要更新浏览器才能使用它。
...
javascriptRequired = Panda Send 需要 JavaScript
whyJavascript = 为什么 Panda Send 需要 JavaScript？
