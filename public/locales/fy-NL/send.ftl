...
sendYourFilesLink = Panda Send probearje
...
notSupportedOutdatedDetail = Spitigernôch stipet dizze ferzje fan Firefox de webtechnology dy't Panda Send mooflik makket net. Jo moatte jo browser fernije.
...
javascriptRequired = Panda Send fereasket JavaScript.
whyJavascript = Werom hat Panda Send JavaScript nedich?
