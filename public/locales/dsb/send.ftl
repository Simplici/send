...
sendYourFilesLink = Panda Send wopytaś
...
notSupportedOutdatedDetail = Bóžko toś ta wersija Firefox webtechnologiju njepódpěra, na kótarejž Panda Send bazěrujo. Musyśo swój wobglědowak aktualizěrowaś.
...
whyJavascript = Cogodla Panda Send JavaScript trjeba?
