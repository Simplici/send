...
sendYourFilesLink = Experimentar o Panda Send
...
notSupportedOutdatedDetail = Infelizmente esta versão do Firefox não suporta a tecnologia web que faz o Panda Send funcionar. Precisa de atualizar o seu navegador.
...
javascriptRequired = O Panda Send requer JavaScript
whyJavascript = Porque é que o Panda Send requer JavaScript?
