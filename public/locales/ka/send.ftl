...
sendYourFilesLink = გამოცადეთ Panda Send
...
notSupportedOutdatedDetail = სამწუხაროდ, Firefox-ის ამ ვერსიას არ გააჩნია ის ტექნოლოგია, რომელიც აუცილებელია Panda Send-ის მუშაობისთვის. გესაჭიროებათ, ბრაუზერის განახლება.
...
javascriptRequired = Panda Send საჭიროებს JavaScript-ს
whyJavascript = რატომ საჭიროებს Panda Send JavaScript-ს?
