...
sendYourFilesLink = 試用 Panda Send
...
notSupportedOutdatedDetail = 很可惜，此版本的 Firefox 不支援 Panda Send 所需的 Web 技術。請更新瀏覽器後再使用。
...
javascriptRequired = Panda Send 需要開啟 JavaScript 功能
whyJavascript = 為什麼 Panda Send 需要 JavaScript 才能使用？
