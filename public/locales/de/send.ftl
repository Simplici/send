...
sendYourFilesLink = Panda Send ausprobieren
...
notSupportedOutdatedDetail = Leider unterstützt diese Firefox-Version die Web-Technologie nicht, auf der Panda Send basiert. Du musst deinen Browser aktualisieren.
...
javascriptRequired = Panda Send benötigt JavaScript
whyJavascript = Warum benötigt Panda Send JavaScript?
