...
sendYourFilesLink = Dùng thử Panda Send
...
notSupportedOutdatedDetail = Thật không may là phiên bản Firefox này không hỗ trợ công nghệ được sử dụng trong Panda Send. Bạn cần cập nhật trình duyệt của bạn.
...
javascriptRequired = Panda Send cần JavaScript
whyJavascript = Tại sao Panda Send cần JavaScript?
