...
sendYourFilesLink = Попробовать Panda Send
...
notSupportedOutdatedDetail = К сожалению, эта версия Firefox не поддерживает веб-технологию, благодаря которой работает Panda Send. Ваш нужно обновить свой браузер.
...
javascriptRequired = Для Panda Send необходим JavaScript
whyJavascript = Почему Panda Send требуется JavaScript?
