...
# Panda Send is a brand name and should not be localized.
downloadMessage = Rakan anda menghantar satu fail kepada anda menggunakan Panda Send, satu perkhidmatan yang membolehkan anda berkongsi fail dengan pautan yang selamat, peribadi dan dienkrip, yang secara automatik akan luput bagi memastikan fail anda tidak terus berada dalam talian selama-lamanya.
...
# Panda Send is a brand name and should not be localized.
sendYourFilesLink = Cuba Panda Send
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Malangnya, pelayar ini tidak menyokong teknologi web yang melaksanakan Panda Send. Anda perlu cuba pelayar lain. Kami syorkan Firefox!
notSupportedLink = Kenapa pelayar saya tidak disokong?
notSupportedOutdatedDetail = Malangnya versi Firefox ini tidak menyokong teknologi web yang menguasakan Panda Send. Anda perlu mengemaskini pelayar anda.
...
legalNoticeTestPilot = Panda Send adalah eksperimen Ujian Perintis, dan tertakluk kepada <a>Terma Perkhidmatan</a> dan <a>Notis Privasi</a> Ujian Perintis. Anda boleh ketahui selanjutnya perihal eksperimen ini dan pengumpulan data <a>di sini</a>.
legalNoticeMozilla = Penggunaan laman web Panda Send juga tertakluk kepada <a>Notis Privasi Laman web</a> dan <a>Terma Penggunaan Laman web</a> Mozilla.
...
javascriptRequired = Panda Send perlukan JavaScript
whyJavascript = Kenapa Panda Send perlukan JavaScript?
