...
# Panda Send is a brand name and should not be localized.
downloadMessage = Shoku juaj po ju dërgon një kartelë me Panda Send, një shërbim që ju lejon të shkëmbeni kartela përmes një lidhjeje të parrezik, private, dhe të fshehtëzuar, që skadon automatikisht, për të garantuar që gjërat tuaja të mos mbeten në internet përgjithmonë.
...
# Panda Send is a brand name and should not be localized.
sendYourFilesLink = Provoni Panda Send
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Mjerisht, ky shfletues nuk mbulon teknologjinë web mbi të cilën bazohet Panda Send.Do t’ju duhet të provoni një shfletues tjetër. Ju këshillojmë Firefox-in!
notSupportedLink = Pse nuk mbulohet ky shfletues?
notSupportedOutdatedDetail = Mjerisht, ky version i Firefox-it nuk e mbulon teknologjinë web mbi të cilën bazohet Panda Send. Do t’ju duhet të përditësoni shfletuesin tuaj.
...
legalNoticeTestPilot = Panda Send është një eksperiment Pilot Testesh dhe subjekt i <a>Kushteve të Shërbimit</a> dhe <a>Shënim Privacësie</a> për Pilot Testesh. <a>Këtu</a> mund të mësoni më tepër mbi këtë eksperiment dhe grumbullimit të të dhënave që ai kryen.
legalNoticeMozilla = Përdorimi i sajtit Panda Send është gjithashtu subjekt i <a>Shënimit Mbi Privatësi Sajtesh</a> të Mozilla-s dhe <a>Kushteve të Përdorimit të Sajtit</a>.
...
javascriptRequired = Panda Send lyp JavaScript
whyJavascript = Ç’i duhet Panda Send-it JavaScript-i?
