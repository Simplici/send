...
sendYourFilesLink = Testa Panda Send
...
notSupportedOutdatedDetail = Tyvärr stödjer den här versionen av Firefox inte webbtekniken som driver Panda Send. Du måste uppdatera din webbläsare.
...
javascriptRequired = Panda Send kräver JavaScript
whyJavascript = Varför kräver Panda Send JavaScript?
