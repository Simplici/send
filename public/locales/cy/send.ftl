...
sendYourFilesLink = Rhowch gynnig ar Panda Send
...
notSupportedOutdatedDetail = Yn anffodus, nid yw'r fersiwn yma o Firefox yn cynnal y technoleg gwe sy'n gyrru Panda Send. Bydd angen i chi ddiweddaru eich porwr.
...
javascriptRequired = Mae Panda Send angen JavaScript
whyJavascript = Pam fod Panda Send angen JavaScript?
