...
# Panda Send is a brand name and should not be localized.
downloadMessage = Ang iyong kaibigan ay nagpapadala sa iyo ng isang file na may Panda Send, isang serbisyo na nagbibigay-daan sa iyo upang magbahagi ng mga file sa isang ligtas, pribado, at naka-encrypt na link na awtomatikong mawawalan ng bisa upang matiyak na ang iyong mga bagay-bagay ay hindi mananatiling online magpakailanman.
...
# Panda Send is a brand name and should not be localized.
notSupportedDetail = Sa kasamaang palad hindi sinusuportahan ng browser na ito ang teknolohiya sa web na nagpapagana ng Panda Send. Kailangan mong subukan ang ibang browser. Inirerekomenda namin ang Firefox!
notSupportedLink = Bakit hindi suportado ang aking browser?
notSupportedOutdatedDetail = Sa kasamaang palad ang bersyon na ito ng Firefox ay hindi sumusuporta sa teknolohiya ng web na nagpapagana ng Panda Send. Kailangan mong i-update ang iyong browser.
