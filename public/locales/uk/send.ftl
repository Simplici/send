...
sendYourFilesLink = Спробуйте Panda Send
...
notSupportedOutdatedDetail = На жаль, ця версія Firefox не підтримує веб-технологію, завдяки якій працює Panda Send. Вам потрібно оновити свій браузер.
...
javascriptRequired = Panda Send потребує JavaScript
whyJavascript = Чому для Panda Send потрібен JavaScript?
